...
Mayor's House is a room. Mayor's House is east of Town Square. Description of Mayor's House is "When you walk into the house, you are stunned by the beautiful furnishing that seems to glitter in the house. At the center of the pearly marble white floor is a large glossy wooden dining table, on top of which is an elegant flower arrangement. Under a magnificent acrylic painting is a polished large leather sofa. The Mayor plops down on the sofa and deflates."
	...
	[Floor]
		Marble white floor is scenery in Mayor's House. Description of Marble White Floor is "Floor."
	[Table]
		Dining Table is scenery in Mayor's House. Description of Dining Table is "Table."
	[Flowers]
		Flower Arrangement is scenery in Mayor's House. Description of Flower Arrangement is "Flower Arrangement."
	[Painting]
		Acrylic Painting is scenery in Mayor's House. Description of Acrylic Painting is "Acrylic painting."
[Mayor]
	Instead of Talking to Mayor when Mayor is in Mayor's House: say "'Mayor, I think we need to hurry.' The Mayor closes his eyes.
	
	'Yes,' he murmurs, 'We should. Alex, I need you to chase my son. I am well past my prime, and cannot leave the villagers. Our Lady only knows what they would do if I walked away from the town. Please go to the Station and save my son.' You nod dutifully, and walk to the exit."; move player to Station.
...
[People]
	Business Men are scenery. Business Men are in Station. Description of Business Men are "Business men."
...
'Marcus. You know, same old same old. How's ya mother? She good?' You nod.
...
[Kiosk Guy]
Kiosk Guy is man in Station. Kiosk Guy is undescribed. Description of Kiosk Guy is "Kiosk Guy." Instead of giving Paper Scrap to Kiosk Guy: say "You firmly place the paper scrap onto the kiosk desk. The man looks up from his book, and takes it. He unfolds the paper, and the corner of his mouth tugs upward. He turns to the cash register, and takes out a wad of cash, carefully counting it before he hands it to you. He does not say a word, and returns to his book."; move Wad of Cash to player; remove Paper Scrap from play.
...
[Conductor]
Conductor is man in Station. Conductor is undescribed. Description of Conductor is "Conductor."
...
Passenger Car is a room. Passenger Car is east of Train Entrance. Passenger Car is west of Observation Car. Description of Passenger Car is "The room is longer than it is wide. There are about 30 open seats, but only a few are occupied. Along the walls are large glass windows. To the East is the Observation Car."

Seats are scenery in Passenger Car. Description of Seats are "Purple cotton seats that look dirty from use. As you walk through the isle, you see the belongings of a few people, including Mark's Backpack, Felix's Briefcase, and Sir Allan's Luggage"
...
4	"[italic type]On the last page is a detailed drawing of a Lady's Flower. Calculations and notes about the stone are scribbled on the margins.[roman type]"
...
Instead of going to a room which is the Bathroom when the Blue Door is in the Passenger Car: say
	...
	You push again, and the lock breaks with a resounding clap. The door swings open and reveals the bathroom."; remove Blue Door from play; move Murder to player.
...
Jewel is thing. Jewel is in Bathroom. Jewel is undescribed.
	After taking Jewel: say "You realize that this jewel belongs to Luna's hairpiece. There is almost no doubt now, Luna is guilty."; Move LunaInformation 7 to Player.
...
Luna's Purse is a closed openable container. Luna is carrying Luna's Purse. Description of Luna's Purse is "A baby pink leather handbag."
	...
	Wallet is a thing in Luna's Purse. Wallet is closed openable container. Description of Wallet is "A luxurious wallet, fat with credit cards and bills."
		After opening Wallet: say "You open the wallet and flip through the bills. You notice a certificate folded neatly inside. In the plastic photo holder, there is a polaroid."; move LunaInformation 2 to player.
...
Novel is a thing. Novel is in Observation Car. Novel is undescribed. Description of Novel is "A brand new romance novel. Luna said that she was reading it, it might be evidence."
		...
		Instead of taking Novel: say "You examine the novel, and you see absolutely no trace of it ever being opened."; Move LunaInformation 6 to player.
...
Instead of talking to Mark, say "[if player is not carrying Murder]He is sleeping in one of the seats. You probably shouldn't disturb him.[end if]

[If player is carrying Murder] You can ask Mark about:
...
Instead of talking to Sir Allan, say " [If player is not carrying Murder]You politely wave at Sir Allan, and he waves back. He approaches you inquires,
...
[if player is not carrying Murder]You politely wave at Sir Allan, and he waves back.[end if]

[If player is carrying Murder]
...
[if player is carrying SirAllanInformation 3] Being the CEO of the Company.[end if]"
...
Instead of talking to Audrey, say "[if player is not carrying Murder]
...
Instead of talking to Luna, say "[if player is not carrying Murder]
...
[if player is carrying LunaInformation 7] Her guilt. [end if]"
